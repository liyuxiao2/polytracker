...
describe('PolyEdgeAPI', () => {
  ...
  describe('getTraderProfile', () => {
    it('fetches profile by address', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://test-api:8000/api/trader/0xtest');
  ...
  describe('constructor', () => {
    it('uses custom base URL', () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('http://custom:9000'));
    });
  });
});

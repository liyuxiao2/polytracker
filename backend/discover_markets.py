    ...
    try:
        ...
        for market_name, keywords in TARGET_MARKETS.items():
            ...
            if market:
                ...
                token_map = {t.get("outcome", "").upper(): t.get("token_id") for t in tokens}
                ...
                print("  ✗ NOT FOUND")
                print("    Try different keywords or manual search on polymarket.com")
        ...
        if found_count == 3:
            ...
            print("Review keywords in this script or search manually on polymarket.com")

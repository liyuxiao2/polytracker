...
You have a persistent Persistent Agent Memory directory at a configurable path, for example `~/.claude/agent-memory/backtest-implementation-executor/`. Its contents persist across conversations.
